...
import { UploadCloud, Image as ImageIcon, FileText, Settings2, Download, Trash2, Zap, PlayCircle, Plus, Sparkles, Loader2, X } from 'lucide-react'
import { cn } from '@/lib/utils'

export default function ImageProcessor() {
  const { items, options, setOptions, isProcessing, addFiles, removeItem, clearAllItems, processAll, downloadAll } = useImageTool()
           ...
           <div className="space-y-3 mt-6">
             ...
             <AnimatePresence>
               {isAllDone && (
                 ...
                 >
                   <Download className="w-4 h-4" /> 打包下载压缩包
                 </motion.button>
               )}
             </AnimatePresence>
           </div>
                  ...
                  <div className="flex items-start justify-between">
                     <div className="flex items-center gap-3 w-[85%]">
                       ...
                       <div className="w-full">
                         ...
                         <p className="text-xs text-slate-500 mt-0.5 font-mono">{(item.file.size / 1024 / 1024).toFixed(2)} MB</p>
                       </div>
                     </div>
